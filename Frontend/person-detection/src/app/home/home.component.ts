    ...
    <div *ngIf="auth.currentUser() !== null">
      <div class="w-full">
        ...
        <p class="${hlmLead} mt-4">
          ...
          and Semantic Segmentation models implemented in .NET using
          OnnxRuntime. Explore the capabilities of YOLOv5, YOLOv8, and Mediapipe
          for comparison, providing real-time insights into their performance
          and functionalities.
        </p>
        <p class="${hlmLead} mt-4">
